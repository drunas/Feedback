...
Если отчёт отправляется от *бригады*, то в тексте письма должны быть перечислены в столбик *почты мэи до @* всех собригадников.
...
Плагиат оценивается неудовлетворительно: нельзя использовать чужой текстовый, графический и прочий интеллектуальный материал. Например, нельзя использовать картинки из описания работы или учебника.
